    ...
    public class AddressbookWorksheet
    {
        ...
        public void WritePersons(IList<Person> persons)
        {
            ...
            foreach (var person in persons)
            {
                ...
                row.PassportIssueDate = person.PassportIssueDate;
                row.PassportExpirationDate = person.PassportExpirationDate;
                row.PlaceOfIssue = person.PlaceOfIssue;
        ...
        private void WriteColumnHeaders()
        {
            ...
            _worksheet.Cells[1, 24].Value = "Pass Ausstellungsort";
            _worksheet.Cells[1, 25].Value = "Junior Karte";
            _worksheet.Cells[1, 26].Value = "Enkel Karte";
